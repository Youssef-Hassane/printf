#include "../main.h"
#include "Generate/Generate_Binary_Representation_2.c"
#include "Generate/Generate_Hexadecimal_Representation.c"
	...
	unsigned int theIndexOfTheBuffer)
{
	...
	binaryRepresentation = Generate_Binary_Representation_2(
		binaryRepresentation,
		theGivenNumber, isNegative, THIRTY_TWO);

	hexadecimalRepresentation = malloc(sizeof(char) * NINE);
	hexadecimalRepresentation = Generate_Hexadecimal_Representation(binaryRepresentation, hexadecimalRepresentation, 0, EIGHT);
